        ...
        {submitStatus === "success" ? (
          <div className={styles.successScreen}>
            ...
            <p className={styles.successText}>
              Thank you, <strong>{formData.fullName || "there"}</strong>. We've received your inquiry for <strong>{formData.serviceInterest || selectedService}</strong>. 
            </p>
            <p className={styles.successText}>
              Our team will prepare a <strong>personalized pricing proposal</strong> and contact you within <strong>24 hours</strong> on business days.
            </p>
          ...
          <form onSubmit={handleSubmit} className={styles.form}>
            <h3 className={styles.title}>Get Pricing Details</h3>
            <p className={styles.subtitle}>
              Fill in your requirements and receive a <strong>personalized pricing proposal</strong> within 24 hours.
            </p>

            <div className={styles.pricingNote}>
              <span className={styles.noteIcon}>💡</span>
              <span>Our pricing is customized based on your specific needs, scale, and requirements.</span>
            </div>
