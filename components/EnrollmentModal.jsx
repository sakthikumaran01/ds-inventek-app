        ...
        {submitStatus === "success" ? (
          <div className={styles.successScreen}>
            ...
            <p className={styles.successText}>
              Thank you for enrolling in <strong>{course.name}</strong>. We've sent a confirmation email to <strong>{formData.email || "your email"}</strong>. Our team will contact you within 24 hours to finalize your batch scheduling.
            </p>
          ...
          <form onSubmit={handleSubmit} className={styles.form}>
            <h3 className={styles.title}>Enroll in Course</h3>
